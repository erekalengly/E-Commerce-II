...
<body>
    ...
    <main>
        <div class="container">
            <div class="lef ">
                <h2 style="margin-bottom: 10px">Book &gt; Product &gt; Cart &gt; Customer Information</h2>
               ...
               <button style="padding: 5px; items-end; color: #fff; border: 1px solid black; background: #FFA9D0 "><a href="{{ url('/payment') }}">Next</a></button>
